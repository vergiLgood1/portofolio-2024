document.addEventListener("DOMContentLoaded", function () {
  ...
  // collectionList.addEventListener("mouseenter", function(event) {
  //   const target = event.target;
  //   const isCollectionList = target.classList.contains("collection-item");

  //   if (isCollectionList) {
  //     const itemId = target.id;
  //     const iconSvg = document.getElementById(`icon-svg${itemId.slice(-1)}`);
  //     const borderContact = document.getElementById(`border-contact${itemId.slice(-1)}`);
  //     const textContact = document.getElementById(`text-contact${itemId.slice(-1)}`);

  //     if (iconSvg && borderContact && textContact) {
  //       iconSvg.style.borderColor = "#ffff";
  //       borderContact.style.borderColor = "#ffffff";
  //       borderContact.style.backgroundColor = "#ffffff";
  //       textContact.style.color = "#000000";
  //     }
  //   }
  // });

  // collectionList.addEventListener("mouseleave", function(event) {
  //   const target = event.target;
  //   const isCollectionList = target.classList.contains("collection-item");
  ...
  //     if (iconSvg && borderContact && textContact) {
  //       iconSvg.style.borderColor = "#000";
  //       borderContact.style.borderColor = "#000";
  //       borderContact.style.backgroundColor = "none";
  //       textContact.style.color = "#000";
  //     }
  //   }
  // });
});
